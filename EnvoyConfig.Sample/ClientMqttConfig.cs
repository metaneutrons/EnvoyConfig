...
namespace EnvoyConfig.Sample
{
    ...
    /// Maps environment variables like MYAPP_CLIENT_X_MQTT_* to properties.
    /// </summary>
    public class ClientMqttConfig
    {
        /// <summary>
        /// Gets or sets the MQTT topic for setting volume.
        /// Maps to: MYAPP_CLIENT_X_MQTT_VOLUME_SET_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_MUTE_SET_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_LATENCY_SET_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_ZONE_SET_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_CONTROL_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_CONNECTED_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_VOLUME_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_MUTE_TOPIC
        /// </summary>
        [Env(Key = "MUTE_TOPIC")]
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_LATENCY_TOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_ZONE_TOPIC
        /// </summary>
        [Env(Key = "ZONE_TOPIC")]
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_STATE_TOPIC
        /// </summary>
        [Env(Key = "STATE_TOPIC")]
