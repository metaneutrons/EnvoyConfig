...
namespace EnvoyConfig.Sample
{
    ...
    /// Maps environment variables like MYAPP_CLIENT_X_KNX_* to properties.
    /// </summary>
    public class ClientKnxConfig
    {
        /// <summary>
        /// Gets or sets whether KNX integration is enabled for this client.
        /// Maps to: MYAPP_CLIENT_X_KNX_ENABLED
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_VOLUME
        /// </summary>
        [Env(Key = "VOLUME")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_VOLUME_STATUS
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_VOLUME_UP
        /// </summary>
        [Env(Key = "VOLUME_UP")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_VOLUME_DOWN
        /// </summary>
        [Env(Key = "VOLUME_DOWN")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_MUTE
        /// </summary>
        [Env(Key = "MUTE")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_MUTE_STATUS
        /// </summary>
        [Env(Key = "MUTE_STATUS")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_MUTE_TOGGLE
        /// </summary>
        [Env(Key = "MUTE_TOGGLE")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_LATENCY
        /// </summary>
        [Env(Key = "LATENCY")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_LATENCY_STATUS
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_ZONE
        /// </summary>
        [Env(Key = "ZONE")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_ZONE_STATUS
        /// </summary>
        [Env(Key = "ZONE_STATUS")]
        ...
        /// Maps to: MYAPP_CLIENT_X_KNX_CONNECTED_STATUS
        /// </summary>
