...
namespace EnvoyConfig.Sample
{
    ...
    /// Maps environment variables like MYAPP_CLIENT_X_* to properties.
    /// </summary>
    public class ClientConfig
    {
        /// <summary>
        /// Gets or sets the display name of the client.
        /// Maps to: MYAPP_CLIENT_X_NAME
        /// </summary>
        [Env(Key = "NAME")]
        ...
        /// Maps to: MYAPP_CLIENT_X_MQTT_BASETOPIC
        /// </summary>
        ...
        /// Maps to: MYAPP_CLIENT_X_DEFAULT_ZONE
        /// </summary>
        ...
        /// Maps environment variables with prefix: MYAPP_CLIENT_X_MQTT_*
        /// </summary>
        ...
        /// Maps environment variables with prefix: MYAPP_CLIENT_X_KNX_*
        /// </summary>
